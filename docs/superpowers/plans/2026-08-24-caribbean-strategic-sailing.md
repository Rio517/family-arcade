...
- [ ] **Step 3: Run normal-route evidence twice through its command**
  ...
  with exact equal normalized semantic state/digests at tick `11855`, while run
